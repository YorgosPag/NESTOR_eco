...
import { createMasterInterventionAction } from '@/app/actions';
...
export function CreateInterventionForm({ setOpen }: { setOpen: (open: boolean) => void }) {
        ...
        <form action={formAction} className="space-y-4 pt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                    <Label htmlFor="id">ID Παρέμβασης (π.χ. EXO-001)</Label>
                    <Input id="id" name="id" required />
                    {state.errors?.id && <p className="text-sm font-medium text-destructive mt-1">{state.errors.id[0]}</p>}
                </div>
                 <div className="space-y-2">
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    <Input id="interventionCategory" name="interventionCategory" required />
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    <Input id="interventionSubcategory" name="interventionSubcategory" />
                </div>
                 <div className="space-y-2">
                    <Label htmlFor="maxUnitPrice">Μέγ. Κόστος/Μονάδα (€)</Label>
                    <Input id="maxUnitPrice" name="maxUnitPrice" type="number" step="0.01" required />
                 ...
                 <div className="space-y-2">
                    ...
                    <Input id="maxAmount" name="maxAmount" type="number" step="0.01" required />
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    <Input id="energySpecsOptions" name="energySpecsOptions" placeholder="π.χ., U < 2.0, 2.0 ≤ U < 2.5" />
                </div>
                 <div className="space-y-2 md:col-span-2">
                    <Label htmlFor="systemClassOptions">Επιλογές Κλάσης Συστήματος (χωρισμένες με κόμμα)</Label>
                    <Input id="systemClassOptions" name="systemClassOptions" placeholder="π.χ., Class A, Class B" />
                </div>
                <div className="space-y-2 md:col-span-2">
